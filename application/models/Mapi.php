	...
	********************************/
	public function listmyideas() {
		...
		if($viv_user_type=='TRMMADMIN') {
					...
					/*** PAGINATION ****/
					 $config = array();
					 $config["base_url"] = site_url('admin/kaizenidea/ideamang/myidea/'.$uri5.'/'.$uri6.'/'.$uri7.'/'.$uri8.'');
			...
			********************************/
			public function downloadkaizenreportexcel($statusname) {
			 ...
			 // file name
					...
					$header = array("Doc No","Version No/ Date","Project Code","KAIZEN Ref.No","Dept.","Originated by -  Name ","Date","Approved Dept","Approved Name","Date","Confirmed by","Date","ACTIVITY","Activity Desc","Benefit Area","Plant Name","Kaizen Theme","Block/Line/Machine/Others","Suggested Kaizen ( Logical Correlation with root cause)","Problem Statement","Counter measure( Engineering solution)","BEFORE","AFTER","Yield","Cycle Time","Cost","Man power","Consumables","Others","Total Savings","Approved by (IE)","Approved by (Accounts)","Emp.ID","TeamName","Function","Root Cause ( Problem Phenomena) Type","Root Cause Explanation ","Brief explanation of present conditions","Brief explanation of Improvements done","Horizontal Deployment","In Other Machines within the cell","Within the Department in all the machine groups","In Other Dept/ Other Location","Any other Relevant Points","Scope and Plan for Horizontal Deployment","Benifits (P,Q,C,S,D,M,E)");
					fputcsv($file, $header);
