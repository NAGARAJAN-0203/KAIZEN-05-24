                              ...
                              <div class="col-xl-12">
                                  <div class="auth-form">
                                     ...
                                     <p class="responsemessage"><?php /*
                                      ...
                                      <form class="m-t" id="formID-1" role="form"    method="post" autocomplete="off" action="<?php echo site_url('admin/mforgotpassword_user') ?>">
                                          <div class="form-group">
                                              <label class="mb-1"><strong>EmpID</strong></label>
                                              <input type="text" id="email" name="email" class="form-control mb10 validate[required]"  >
                                          </div>
