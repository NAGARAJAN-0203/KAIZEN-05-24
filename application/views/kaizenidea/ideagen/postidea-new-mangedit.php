...
Q - This poka yoke will make sure the rail orientation is always right.              S -  This will ensure and prevent mold or part damage and improves mold
 ...
 <div class="row">
  ...
  <form id="formID-1"  action="<?php if($status=='1') { echo site_url('admin/updateidea_ideagen_manageredit'); } else {
		echo '';
          ...
          <!--Div-->
                 ...
                 <div class="card-body">
                    <div class="basic-form">
												 ...
												 <div class="right-box-padding">
														...
														<div class="card-body">
															...
															<div class="form-group mb10 radiotick">
																...
																<label title="MURA" class="mlmin12"><input type="checkbox" class="hideradio" name="activity[]" <?php if(in_array("MURA", $activity_ex)) { echo 'checked'; } ?> value="MURA" <?php if($status=='1') { } else { echo 'readonly'; }  ?> /> <img class="higwei20" />MURA</label>

																<label title="MURI" class="mlmin12"><input type="checkbox" class="hideradio" name="activity[]" <?php if(in_array("MURI", $activity_ex))  { echo 'checked'; } ?> value="MURI" <?php if($status=='1') { } else { echo 'readonly'; }  ?> /> <img class="higwei20" />MURI</label>

																<label title="MUDA" class="mlmin12"><input type="checkbox" class="hideradio" name="activity[]" <?php if(in_array("MUDA", $activity_ex)) { echo 'checked'; } ?> value="MUDA" <?php if($status=='1') { } else { echo 'readonly'; }  ?> /> <img class="higwei20" />MUDA</label>
														 </div>

														 <div class="form-group">
															 <textarea class="form-control mb10" name="activity_desc" <?php if($status=='1') { } else { echo 'readonly'; }  ?> id="activity_desc"><?php echo $activity_desc; ?></textarea>
														 </div>
	                                 ...
	                                 <input type="checkbox" name="benifit_area[]" value="P" class="tab-input" <?php if(in_array("P", $benifit_area_ex)) { echo 'checked'; } ?> <?php if($status=='1') { } else { echo 'readonly'; }  ?>>
	                                 <div class="tab-box">P</div>
	                               </label>

																 <label class="tab tabcheckbox">
	                                 <input type="checkbox" name="benifit_area[]" value="Q" class="tab-input" <?php if(in_array("Q", $benifit_area_ex)) { echo 'checked'; } ?> <?php if($status=='1') { } else { echo 'readonly'; }  ?>>
	                                 <div class="tab-box">Q</div>
	                               </label>

																 <label class="tab tabcheckbox">
																	 <input type="checkbox" name="benifit_area[]" value="D" class="tab-input" <?php if(in_array("C", $benifit_area_ex)) { echo 'checked'; } ?> <?php if($status=='1') { } else { echo 'readonly'; }  ?>>
																	 <div class="tab-box">C</div>
																 </label>

																 <label class="tab tabcheckbox">
	                                 <input type="checkbox" name="benifit_area[]" value="D" class="tab-input" <?php if(in_array("D", $benifit_area_ex)) { echo 'checked'; } ?> <?php if($status=='1') { } else { echo 'readonly'; }  ?>>
	                                 <div class="tab-box">D</div>
	                               </label>

																 <label class="tab tabcheckbox">
	                                 <input type="checkbox" name="benifit_area[]" value="S" class="tab-input" <?php if(in_array("S", $benifit_area_ex)) { echo 'checked'; } ?> <?php if($status=='1') { } else { echo 'readonly'; }  ?>>
	                                 <div class="tab-box">S</div>
	                               </label>

																 <label class="tab tabcheckbox">
	                                 <input type="checkbox" name="benifit_area[]" value="M" class="tab-input" <?php if(in_array("M", $benifit_area_ex)) { echo 'checked'; } ?> <?php if($status=='1') { } else { echo 'readonly'; }  ?>>
	                                 <div class="tab-box">M</div>
	                               </label>

																 <label class="tab tabcheckbox">
	                                 <input type="checkbox" name="benifit_area[]" value="E" class="tab-input" <?php if(in_array("E", $benifit_area_ex)) { echo 'checked'; } ?> <?php if($status=='1') { } else { echo 'readonly'; }  ?>>
	                                 <div class="tab-box">E</div>
	                               </label>
															 </label>
														</div>
												...
												<div class="right-box-padding">
													 ...
													 <div class="card-body">
														 ...
														 <div class="form-group">
																...
																<input type="text" name="doc_no" class="form-control mb10" value="<?php  if(empty($doc_no)) { echo "TEPL-IE-C-FR-0005"; } else { echo $doc_no; } ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
														 </div>
													 	</div>
														...
														<div class="col-sm-6">
														 <div class="form-group">
																...
																<input type="text" name="version_no" class="form-control mb10" value="<?php   if(empty($version_no)) { echo "01/".date("d.m.Y").""; } else { echo $version_no; } ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
														 </div>
													 </div>
													 ...
													 <div class="col-sm-6">
														 <div class="form-group">
																...
																<input type="text" name="proj_code" id="proj_code" required class="form-control mb10 " value="<?php echo $proj_code; ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
														 </div>
													 </div>
													 ...
													 <div class="col-sm-6">
														 <div class="form-group">
																...
																<input type="text" name="ref_no" id="ref_no" required class="form-control" value="<?php echo $ref_no; ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
														 </div>
													 </div>
												 </div> <!--row-->
												...
												<div class="right-box-padding">
													 ...
													 <div class="card-body">
														...
														<div class="form-group">
															...
															<input type="text" name="ktheme" id="ktheme" required class="form-control" value="<?php echo $ktheme; ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
													   </div>
													 	</div>
														...
														<div class="form-group">
															...
															<input type="text" name="tepl_plant" required id="tepl_plant" class="form-control" value="<?php echo $tepl_plant; ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
													   </div>
													 	</div>
														...
														<div class="form-group">
															...
															<input type="text" name="idea" id="idea" class="form-control " value="<?php echo $idea; ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
													   </div>
													 	</div>
													</div><!--row-->
											 ...
											 <div class="right-box-padding">
													...
													<div class="card-body">
														...
														<div class="form-group">
															...
															<textarea class="textarea50" <?php if($status=='1') { } else { echo 'readonly'; }  ?> name="prob_stmt"><?php echo $rowArray->prob_stmt; ?></textarea>
													 	</div>
												 		</div>
														...
														<div class="form-group">
															...
															<textarea class="textarea50" name="count_measur" <?php if($status=='1') { } else { echo 'readonly'; }  ?>><?php echo $rowArray->count_measur; ?></textarea>
													 	</div>
												 		</div>
													</div><!--row-->
										 ...
										 <div class="right-box-padding">
												...
												<div class="card-body">
													...
													<div class="form-group">
														...
														<input type="text" name="cs_quality" class="form-control mb10" value="<?php echo $rowArray->cs_quality; ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
													</div>
													</div>
													*/ ?>
													...
													<div class="form-group">
														...
														<input type="text" name="cs_yield" class="form-control mb10" value="<?php echo $rowArray->cs_yield; ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
													</div>
													</div>
													...
													<div class="form-group">
														...
														<input type="text" name="cs_cycletime" class="form-control mb10 inpchangecls cs_cycletime" value="<?php $cs_cycletime =  $rowArray->cs_cycletime; echo $cs_cycletime; ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
													</div>
													</div>
													...
													<div class="form-group">
														...
														<input type="text" name="cs_cost" class="form-control mb10 cs_costenter validate[custom[integer]]" value="<?php $cs_cost = $rowArray->cs_cost; echo $cs_cost; ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
													</div>
													</div>
													...
													<div class="form-group">
														...
														<input type="text" name="cs_material" class="form-control mb10" value="<?php echo $rowArray->cs_material; ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
													</div>
													</div>
													*/ ?>
													...
													<div class="form-group">
														...
														<input type="text" name="cs_manpower" class="form-control mb10 inpchangecls cs_manpower" value="<?php $cs_manpower = $rowArray->cs_manpower; echo $cs_manpower; ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
													</div>
													</div>
													...
													<div class="form-group">
														...
														<input type="text" name="cs_consumables" class="form-control mb10" value="<?php echo $rowArray->cs_consumables; ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
													</div>
													</div>
													...
													<div class="form-group">
														...
														<input type="text" name="cs_others" class="form-control mb10" value="<?php echo $rowArray->cs_others; ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
													</div>
													</div>
													...
													<div class="form-group">
														...
														<input type="text" name="cs_totalsavings" class="form-control mb10" value="<?php echo $rowArray->cs_totalsavings; ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
													</div>
													</div>
													...
													<div class="form-group">
														...
														echo $cs_appr_ie;
														 ...
														 ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
													</div>
													</div>
													...
													<div class="form-group">
														...
														<input type="text" name="cs_standardization" class="form-control mb10" value="<?php echo $rowArray->cs_standardization; ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
													</div>
													</div>
													...
													<div class="form-group">
														...
														<input type="text" name="cs_sopsp" class="form-control mb10" value="<?php echo $rowArray->cs_sopsp; ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
													</div>
													</div>
													...
													<div class="form-group">
														...
														<input type="text" name="cs_drawing" class="form-control mb10" value="<?php echo $rowArray->cs_drawing; ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
													</div>
													</div>
												...
												<div class="card-body">
													...
													<div class="row">
														...
														<table class="tablerefresh_teammemb width100per">
															...
															<tr>
																<td width="10%">
																	<input type="text" name="eempid" placeholder="" class="eempid typeempid" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />

																</td>
																	<td width="30%">
																		<input type="text" name="teamname" placeholder="" class="eteamname etypefname" <?php if($status=='1') { } else { echo 'readonly'; }  ?> /></td>
																	<td width="30%"><input type="text" name="function" placeholder="" class="efunction etypedepart" class="efunction" <?php if($status=='1') { } else { echo 'readonly'; }  ?> /></td>
																	 <input type="hidden" class="eideaid width53" name="eideaid" value="<?php echo $uri5; ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
			 							 ...
			 							 <div class="right-box-padding">
			 									...
			 									<div class="card-body">
			 										...
			 										<div class="form-group">
														...
														?>
														<select name="root_cause[]" class="form-control mb10" <?php if($status=='1') { } else { echo 'readonly'; }  ?> multiple>
																						<option value="">Select</option>
														...
														Attachment <br/>
														<?php /*
														<textarea class="textarea50" name="root_cause_exp" <?php if($status=='1') { } else { echo 'readonly'; }  ?>><?php
													 ...
													 <!--END Attach File-->
														...
														<textarea class="textarea50" name="root_cause_block" <?php if($status=='1') { } else { echo 'readonly'; }  ?>><?php
			 										...
			 										<div class="form-group">
			 											...
			 											<textarea class="textarea331" name="brf_exp_precond" <?php if($status=='1') { } else { echo 'readonly'; }  ?>><?php echo $rowArray->brf_exp_precond; ?></textarea>
			 										</div>
			 										</div>
													...
													<div class="col-sm-4">
			 										<div class="form-group">
			 											...
			 											<textarea class="textarea331" name="brf_exp_impdone" <?php if($status=='1') { } else { echo 'readonly'; }  ?>><?php echo $rowArray->brf_exp_impdone; ?></textarea>
			 										</div>
			 										</div>
			 									</div><!--row-->
										...
										<div class="right-box-padding">
											 ...
											 <div id="enbdisblur" class="<?php if($horizradio=='NO') { echo 'blurdiv'; } ?>">
												 <div class="form-group">
														...
														<input type="text" name="horizontal1" value="<?php echo $rowArray->horizontal1; ?>" class="form-control mb10" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
												 </div>

												 <div class="form-group">
														<label>Within the Department in all the machine groups </label>
														<input type="text" name="horizontal2" value="<?php echo $rowArray->horizontal2; ?>" class="form-control mb10" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
												 </div>

												 <div class="form-group">
														<label>In Other Dept/ Other Location </label>
														<input type="text" name="horizontal3" value="<?php echo $rowArray->horizontal3; ?>" class="form-control mb10" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
												 </div>

												 <div class="form-group">
														<label>Any other Relevant Points</label>
													 <input type="text" name="horizontal4" value="<?php echo $rowArray->horizontal4; ?>" class="form-control mb10" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
												 </div>
											 ...
											 <div class="row">
												 ...
												 <table class="tablerefresh_sustenance">
													 ...
													 <tr><td>
															 ...
															 ?>
														 <input readonly type="text" name="sn" class="form-control esn" value="<?php echo $ssn; ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> /></td>
														 <td><input type="text" name="mc" class="form-control emc" value="" <?php if($status=='1') { } else { echo 'readonly'; }  ?> /></td>
														 <td><input type="text" name="targetdate" class="form-control etargetdate" value="" <?php if($status=='1') { } else { echo 'readonly'; }  ?> /></td>
														 <td><input type="text" name="responsi" class="form-control eresponsi" value="" <?php if($status=='1') { } else { echo 'readonly'; }  ?> /></td>
														 <td><input type="text" name="status" class="form-control estatus" value="" <?php if($status=='1') { } else { echo 'readonly'; }  ?> /></td>
							 	 ...
							 	 <div class="right-box-padding">
							 			...
							 			<div class="card-body">
							 				...
							 				<div class="form-group">
							 					...
							 					<textarea class="textarea292" name="benifits" <?php if($status=='1') { } else { echo 'readonly'; }  ?>><?php echo $rowArray->benifits; ?></textarea>
							 				</div>
							 				</div>
									...
									<div class="right-box-padding">
										 ...
										 <div class="card-body">
											 ...
											 <table class="width100per">
												 ...
												 <tr class="borderedtd">
													<td>Name</td>
													<td><input type="text" <?php if($status=='1') { } else { echo 'readonly'; }  ?> name="origi_name" value="<?php
													...
													<td>
													 ...
													 if(empty($origi_dept)) {
 													 ...
 													 ?>
														...
														<?php } else {  ?>
														 <input type="text" name="approv_name" <?php if($status=='1') { } else { echo 'readonly'; }  ?> value="<?php echo $approv_name; ?>" class="form-control mb10" />
														<?php }  ?>
													...
													<td  class="blurdiv"><input type="text" name="confirm_name" value="<?php echo $rowArray->confirm_name; ?>" class="form-control" <?php if($status=='1') { } else { echo 'readonly'; }  ?> /></td>
													</tr>


												 <tr class="borderedtd">
													 <td>Dept</td>
													 <td><input type="text" <?php if($status=='1') { } else { echo 'readonly'; }  ?> name="origi_dept" value="<?php
													 $origi_dept = $rowArray->origi_dept;
													 if(empty($origi_dept)) {
							                ...
							                <?php } * ?>
														 ...
														 */ ?>
														 ...
														 <input type="text" name="approv_dept" <?php if($status=='1') { } else { echo 'readonly'; }  ?> value="<?php echo $findmanagerdepartbypid; ?>" class="form-control mb10" />

														 <?php } else {  ?>
															<input type="text" name="approv_dept" <?php if($status=='1') { } else { echo 'readonly'; }  ?> value="<?php echo $approv_dept; ?>" class="form-control mb10" />
														 <?php }  ?>
													 </td>
													 <td class="blurdiv"><input type="text" name="confirm_dept" value="<?php echo $rowArray->confirm_dept; ?>" class="form-control" <?php if($status=='1') { } else { echo 'readonly'; }  ?> /></td>
 												 </tr>


												 <tr class="borderedtd">
													 <td>Date</td>
													 <td><input type="date"  id="origi_date1" name="origi_date" <?php if($status=='1') { } else { echo 'readonly'; }  ?> value="<?php
													 ...
													 <td><input type="date" id="approv_date1" <?php if($status=='1') {  } else { echo 'readonly'; } ?> name="approv_date" value="<?php
													 ...
													 <td  class="blurdiv"><input <?php if($status=='1') {  } else { echo 'readonly'; } ?> type="text" name="confirm_date" value="<?php echo $rowArray->confirm_date; ?>" class="form-control"  /></td>
 												 </tr>
 											 </table>
				...
				<?php } ?>
                 ...
                 <div class="form-group col-md-6">
                   <input type="hidden" name="ideaid" value="<?php echo $uri5; ?>" />
									 ...
									 <a href="<?php
 				 								echo site_url('admin/kaizenidea/ideagen/postidea/'.$uri5.'');
 				 					?>"  class="btn btn-warning colorfff">Cancel & Back</a>


									 <span style="width:100px;">&nbsp;</span>
                   <button type="submit" id="submittodri" class="btn btn-primary" name="submit" value="submitit">Submit & Update</button>
								 <?php }  ?>
