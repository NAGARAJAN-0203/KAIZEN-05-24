...
<div class="container-fluid">
  ...
  <h4>View Submitted Ideas for Verification</h4>
  <span>Ideas Generation > Ideas Mang > View Submitted Ideas from Employee</span>
  </div>
  </div>
  </div>
  <!--END Page Title-->
          ...
          <a href="<?php echo site_url('admin/kaizenidea/ideagen/ideaverification/totalsubmitted'); ?>">
           <div class="divcount pull-right">
            <div class="bgl-primary rounded p-2">
              <p class="mb-0 counttitle">Total Ideas</p>
              <p class="mb-0 countnumb text-center"><b><?php
              $count_listmyideas_verifiy = $this->mapi->count_listmyideas_verifiy_ideagen();
          ...
          <a href="<?php echo site_url('admin/kaizenidea/ideagen/ideaverification/totalpending'); ?>">
           <div class="divcount pull-right">
            <div class="bgl-warning dashborder rounded p-2">
              <p class="mb-0 counttitle">Pending Ideas</p>
              <p class="mb-0 countnumb text-center blink_me_brown"><b><?php
              $count_listmyideas_verifiy_sts_p = $this->mapi->count_listmyideas_verifiy_sts_ideagen('1');
          ...
          <a href="<?php echo site_url('admin/kaizenidea/ideagen/ideaverification/totalapproved'); ?>">
           <div class="divcount pull-right">
            <div class="bgl-success dashborder rounded p-2">
              <p class="mb-0 counttitle">Approved Ideas</p>
              <p class="mb-0 countnumb text-center "><b><?php
              $count_listmyideas_verifiy_sts_a = $this->mapi->count_listmyideas_verifiy_sts_ideagen('2');
          ...
          <a href="<?php echo site_url('admin/kaizenidea/ideagen/ideaverification/totalrejected'); ?>">
           <div class="divcount pull-right">
            <div class="bgl-danger dashborder rounded p-2">
              <p class="mb-0 counttitle">Rejected Ideas</p>
              <p class="mb-0 countnumb text-center "><b><?php
              $count_listmyideas_verifiy_sts_r = $this->mapi->count_listmyideas_verifiy_sts_ideagen('3');
  ...
  <!--END Page Title-->
                 ...
                 */ ?>
                   ...
                   <table id="tabletoexcel" class="table table-bordered table-responsive-sm tablerefresh tablefixheadcolumn tasklistautorefresh">
                       ...
                       <tbody>
                         ...
                         $listmyideas_verification = $this->mapi->listmyideas_verification_ideagen();
                         ...
                         <?php } else {
                          ...
                          ?>
                           ...
                           <tr class="">
                               ...
                               <td>
                                  <p>Idea Theme : <b><?php echo $ktheme; ?></b>
    ...
    <div class="container-fluid">
      ...
      <div class="welcome-text">
      <h4>View Submitted Ideas for Verification</h4>
      <span>Ideas Generation > Ideas Mang > View Submitted Ideas by DRI Approved</span>
      </div>
      </div>
      </div>
      <!--END Page Title-->
      ...
      <div class="welcome-text">
        ...
        <div class="">
              ...
              <a href="<?php echo site_url('admin/kaizenidea/ideagen/ideaverification/totalsubmitted'); ?>">
               <div class="divcount pull-right">
                <div class="bgl-primary rounded p-2">
                  <p class="mb-0 counttitle">Total Ideas DRI Approved</p>
                  <p class="mb-0 countnumb text-center"><b><?php
                  $count_listmyideas_verifiy_iedept = $this->mapi->count_listmyideas_verifiy_iedept_ideagen();
              ...
              <a href="<?php echo site_url('admin/kaizenidea/ideagen/ideaverification/totalpending'); ?>">
               <div class="divcount pull-right">
                <div class="bgl-warning dashborder rounded p-2">
                  <p class="mb-0 counttitle">Ideas Approval Pending</p>
                  <p class="mb-0 countnumb text-center blink_me_brown"><b><?php
                  $count_listmyideas_verifiy_sts_iedept = $this->mapi->count_listmyideas_verifiy_sts_iedept_ideagen('1');
              ...
              <a href="<?php echo site_url('admin/kaizenidea/ideagen/ideaverification/totalapproved'); ?>">
               <div class="divcount pull-right">
                <div class="bgl-success dashborder rounded p-2">
                  <p class="mb-0 counttitle">Ideas Approved </p>
                  <p class="mb-0 countnumb text-center "><b><?php
                  $count_listmyideas_verifiy_sts_iedept = $this->mapi->count_listmyideas_verifiy_sts_iedept_ideagen('2');
                  echo $count_listmyideas_verifiy_sts_iedept;
                  ?></b></p>
                </div>
              </div>
              ...
              <a href="<?php echo site_url('admin/kaizenidea/ideagen/ideaverification/totalrejected'); ?>">
               <div class="divcount pull-right">
                <div class="bgl-danger dashborder rounded p-2">
                  <p class="mb-0 counttitle">Ideas Rejected </p>
                  <p class="mb-0 countnumb text-center "><b><?php
                  $count_listmyideas_verifiy_sts_iedept = $this->mapi->count_listmyideas_verifiy_sts_iedept_ideagen('3');
                  echo $count_listmyideas_verifiy_sts_iedept;
                  ?></b></p>
                </div>
              </div>
      ...
      <!--END Page Title-->
                     ...
                     */ ?>
                       ...
                       <table id="tabletoexcel" class="table table-bordered table-responsive-sm tablerefresh tablefixheadcolumn tasklistautorefresh">
                           ...
                           <tbody>
                             ...
                             $listmyideas_verifiy_iedept = $this->mapi->listmyideas_verifiy_iedept_ideagen();
        ...
        <div class="container-fluid">
          ...
          <div class="welcome-text">
          <h4>View Submitted Ideas for Verification</h4>
          <span>Ideas Generations > Ideas Mang > View Submitted Ideas by DRI Approved</span>
          </div>
          </div>
          </div>
          <!--END Page Title-->
                  ...
                  <a href="<?php echo site_url('admin/kaizenidea/ideagen/ideaverification/totalsubmitted'); ?>">
                   <div class="divcount pull-right">
                    <div class="bgl-primary rounded p-2">
                      ...
                      <p class="mb-0 countnumb text-center"><b><?php
                      $count_listmyideas_verifiy_finance = $this->mapi->count_listmyideas_verifiy_finance_ideagen();
                  ...
                  <a href="<?php echo site_url('admin/kaizenidea/ideagen/ideaverification/totalpending'); ?>">
                   <div class="divcount pull-right">
                    <div class="bgl-warning dashborder rounded p-2">
                      ...
                      <p class="mb-0 countnumb text-center blink_me_brown"><b><?php
                      $count_listmyideas_verifiy_sts_finance = $this->mapi->count_listmyideas_verifiy_sts_finance_ideagen('1');
                  ...
                  <a href="<?php echo site_url('admin/kaizenidea/ideagen/ideaverification/totalapproved'); ?>">
                   <div class="divcount pull-right">
                    <div class="bgl-success dashborder rounded p-2">
                      ...
                      <p class="mb-0 countnumb text-center "><b><?php
                      $count_listmyideas_verifiy_sts_finance = $this->mapi->count_listmyideas_verifiy_sts_finance_ideagen('2');
                      echo $count_listmyideas_verifiy_sts_finance;
                      ?></b></p>
                    </div>
                  </div>
                  ...
                  <a href="<?php echo site_url('admin/kaizenidea/ideagen/ideaverification/totalrejected'); ?>">
                   <div class="divcount pull-right">
                    <div class="bgl-danger dashborder rounded p-2">
                      ...
                      <p class="mb-0 countnumb text-center "><b><?php
                      $count_listmyideas_verifiy_sts_finance = $this->mapi->count_listmyideas_verifiy_sts_finance_ideagen('3');
                      echo $count_listmyideas_verifiy_sts_finance;
                      ?></b></p>
                    </div>
                  </div>
                         ...
                         */ ?>
                           ...
                           <table id="tabletoexcel" class="table table-bordered table-responsive-sm tablerefresh tablefixheadcolumn tasklistautorefresh">
                               ...
                               <tbody>
                                 ...
                                 $listmyideas_verifiy_finance = $this->mapi->listmyideas_verifiy_finance_ideagen();
                                       ...
                                       <td>
                                         <p>Doc No : <b><?php echo $doc_no; ?></b>
                                          ...
                                          <?php } else if($status==3) { ?>
                                                <span class="badge bgmildred">Rejected</span>
                                          <?php } else if($status==4) { ?>
                                              <span class="badge bgmildgray">IE Dept Approved <?php
                                              if($cs_cost>=50000) { echo '& Waiting for Finance Approval'; }
                                              ?></span>

                                          <?php } else if($status==5) { ?>
                                              <span class="badge bgmildred">IE Dept Rejected</span>
                                          <?php } else if($status==6) {  ?>
                                              <span class="badge bgmildgreen">Finance Dept Approved</span>
                                            <?php } else if($status==7) {  ?>
                                                <span class="badge bgmildred">Finance Dept Rejected</span>
                                            <?php } ?>
