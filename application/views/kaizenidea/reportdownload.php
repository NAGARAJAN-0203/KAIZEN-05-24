...
<div class="container-fluid">
  ...
  <h4>Report</h4>
  <span>Kaizen Form > Report Downloads</span>
...
<div class="row page-titles mx-0">
  ...
  <div class="media mb-2">
    <h5 class="my-1 text-primary">Report List :</h5>
        ...
        <tbody>
            ...
            <tr class="">
                ...
                <td class="text-center">
                  ...
                  <a href="<?php echo site_url('admin/downloadkaizenreportexcel/allkaizens'); ?>" class="btn btn-warning shadow" >Download</a>
                 ...
                 <td class="text-center">1</td>
                 <td>
                   <p><b>Idea Generation </b>
                     <span class="pull-right">
                       Total Rows :
                       <span class="badge bgmildgray"><?php
                     	$tsts = '1,2,3,4,5,6,7';
                     	$count_listmyideas = $this->mapi->count_listmyideasbystatus_ideagen('',$tsts);
                     	echo $count_listmyideas;
                     	?></span>
                        </b></span>
                    </p>
                 ...
                 <td class="text-center">
                   <div class="d-flex align-center84">
                   <a href="<?php echo site_url('admin/downloadideareportexcel/allideas'); ?>" class="btn btn-warning shadow" >Download</a>
