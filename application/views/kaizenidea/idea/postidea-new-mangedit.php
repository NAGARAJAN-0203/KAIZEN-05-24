...
<h4>Edit Kaizen
	...
	<?php if($status=='1') {  ?>
	<button class="btn btn-primary pull-right" type="button" data-toggle="modal" data-target="#samplekaizenformmodel">Sample Kaizen Form</button>
	<?php } else { ?>
	...
	if($viv_user_type=='TRMMEMP') { ?>
		<a href="<?php echo site_url('admin/kaizenidea/ideamang/myidea'); ?>" class="btn btn-primary pull-right" type="button">Back to Kaizen List</a>

	<?php } elseif($viv_user_type=='TRMMMANG') { ?>
		<a href="<?php echo site_url('admin/kaizenidea/ideamang/ideaverification'); ?>" class="btn btn-primary pull-right" type="button">Back to Kaizen Verification List</a>
...
Q - This poka yoke will make sure the rail orientation is always right.              S -  This will ensure and prevent mold or part damage and improves mold
 ...
 <div class="row">
  ...
  <form id="formID-1"  action="<?php
	...
	if($status=='1') { echo site_url('admin/updateidea_manageredit'); }
	else { echo ''; }

	?>"   method="post" autocomplete="off"   enctype="multipart/form-data" class="formID">
          <!--Div-->
                  <div class="card-header">
                    <h4 class="card-title">Edit Kaizen</h4>
                 </div>
                 <div class="card-body">
												...
												<div class="right-box-padding">
													 ...
													 <div class="col-sm-6">
														 <div class="form-group">
																...
																<input type="text" required name="proj_code" id="proj_code" class="form-control mb10 " value="<?php echo $proj_code; ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
														 </div>
													 </div>
													 ...
													 <div class="col-sm-6">
														 <div class="form-group">
																...
																<input type="text" required name="ref_no" id="ref_no" class="form-control " value="<?php echo $ref_no; ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
														 </div>
													 </div>
												 </div> <!--row-->
													 ...
													 <div class="card-body">
														...
														*/ ?>
														...
														<div class="form-group">
															...
															<input type="text" name="tepl_plant" id="tepl_plant" required class="form-control" value="<?php echo $tepl_plant; ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
													   </div>
													 	</div>
														...
														<div class="form-group">
															...
															<input type="text" required name="idea" id="idea" class="form-control" value="<?php echo $idea; ?>" <?php if($status=='1') { } else { echo 'readonly'; }  ?> />
													   </div>
													 	</div>
													</div><!--row-->
										 ...
										 <div class="card-body">
							                ...
							                <?php } * ?>
														 ...
														 */ ?>
														 ...
														 <input type="text" name="approv_dept" <?php if($status=='1') { } else { echo 'readonly'; }  ?> value="<?php echo $findmanagerdepartbypid; ?>" class="form-control mb10" readonly />

														 <?php } else {  ?>
															<input type="text" name="approv_dept" <?php if($status=='1') { } else { echo 'readonly'; }  ?> value="<?php echo $approv_dept; ?>" class="form-control mb10" readonly />
														 <?php }  ?>
													 </td>
				...
				<?php } ?>
                 ...
                 <div class="form-group col-md-6">
                   <input type="hidden" name="ideaid" value="<?php echo $uri5; ?>" />
									 ...
									 <a href="<?php
 				 								echo site_url('admin/kaizenidea/ideamang/postidea/'.$uri5.'');
				...
				if($status=='2' && $findiedeptemailbypid==$viv_email) { ?>
					...
					<p>&nbsp;</p>
								<?php //if($viv_user_type=='TRMMHOD' || $viv_user_type=='TRMMADMIN') {
									?>
									<form action="<?php echo site_url('admin/updateideastatus_iedept'); ?>"   method="post" autocomplete="off"   enctype="multipart/form-data" class="formID">
									<input type="hidden" name="ideaid" value="<?php echo $uri5; ?>" />
