...
(function($) {
    ...
    if(jQuery('#lineChart_3').length > 0 ){
        ...
        new Chart(lineChart_3, {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: "Received Fees (Clients)",
                        data: [10,11,12,12,34,34,56,56,45,34,12,12],
                        borderColor: lineChart_3gradientStroke1,
                        borderWidth: "2",
                        backgroundColor: 'transparent',
                        pointBackgroundColor: 'rgba(58, 122, 254, 0.5)'
                    }, {
                        label: "Pending Fees (Clients)",
                        data: [13,16,12,14,34,34,44,56,45,34,32,42],
    ...
    if(jQuery('#lineChart_2').length > 0 ){
        ...
        <?php
        $totalmonthkaizenbyyear = $this->mapi->totalmonthkaizenbyyear($uri5);
     	 //echo $count_totalmonthkaizenbyyear;
     	 $totalmonthkaizenbyyear_ex = explode(",",$totalmonthkaizenbyyear);
     	 $totalmonthkaizenbyyear_max = max($totalmonthkaizenbyyear_ex);
     	 //$doubletotal_totalmonthkaizenbyyear = $totalmonthkaizenbyyear_max + 20;
       $doubletotal_totalmonthkaizenbyyear = $totalmonthkaizenbyyear_max * 1.5;
        ?>
                ...
                datasets: [
                    {
                        ...
                        data: [<?php echo $totalmonthkaizenbyyear; ?>],
            ...
            options: {
                ...
                scales: {
                    yAxes: [{
                        ticks: {
                            beginAtZero: true,
                            max: <?php echo $doubletotal_totalmonthkaizenbyyear; ?>,
                            min: 0,
                            stepSize: 20,
                            padding: 10
                        }
    ...
    <?php
    $totalmonthkaizenbyyear_status_app = $this->mapi->totalmonthkaizenbyyear_status($uri5,2);

    $totalmonthkaizenbyyear_status_app_ex = explode(",",$totalmonthkaizenbyyear_status_app);
    $totalmonthkaizenbyyear_status_app_max = max($totalmonthkaizenbyyear_status_app);


    $totalmonthkaizenbyyear_status_rej = $this->mapi->totalmonthkaizenbyyear_status($uri5,3);
    $totalmonthkaizenbyyear_status_rej_ex = explode(",",$totalmonthkaizenbyyear_status_rej);
    $totalmonthkaizenbyyear_status_rej_max = max($totalmonthkaizenbyyear_status_rej);

   //$totalmonthkaizenbyyear_status_max = max($totalmonthkaizenbyyear_status_ex);
   //$doubletotal_totalmonthkaizenbyyear = $totalmonthkaizenbyyear_max + 20;
   $totalmonthkaizenbyyear_status = $totalmonthkaizenbyyear_status_app_max + $totalmonthkaizenbyyear_status_rej_max;
    ?>
    //stalked bar chart
    ...
    if(jQuery('#barChart_4').length > 0 ){
        ...
        //generate gradient
        const barChart_4gradientStroke = barChart_4.createLinearGradient(50, 100, 50, 50);
        barChart_4gradientStroke.addColorStop(0, "rgba(58, 122, 254, 1)");
        barChart_4gradientStroke.addColorStop(1, "rgba(58, 122, 254, 0.5)");

        const barChart_4gradientStroke2 = barChart_4.createLinearGradient(50, 100, 50, 50);
        barChart_4gradientStroke2.addColorStop(0, "rgba(254, 176, 25, 1)");
        barChart_4gradientStroke2.addColorStop(1, "rgba(254, 176, 25, 1)");

        const barChart_4gradientStroke3 = barChart_4.createLinearGradient(50, 100, 50, 50);
        barChart_4gradientStroke3.addColorStop(0, "rgba(40, 199, 111, 1)");
        barChart_4gradientStroke3.addColorStop(1, "rgba(40, 199, 111, 1)");

        barChart_4.height = 100;
        ...
        let barChartData = {
            ...
            datasets: [{
                label: 'Red',
                backgroundColor: barChart_4gradientStroke,
                hoverBackgroundColor: barChart_4gradientStroke,
                data: [
                    '12',
                    '12',
                    '12',
                ...
                label: 'Green',
                backgroundColor: barChart_4gradientStroke2,
                hoverBackgroundColor: barChart_4gradientStroke2,
                data: [
                    '12',
                    '12',
                    '12',
                ...
                label: 'Blue',
                backgroundColor: barChart_4gradientStroke3,
                hoverBackgroundColor: barChart_4gradientStroke3,
                data: [
                    '12',
                    '12',
                    '12',
