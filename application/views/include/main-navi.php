...
<ul class="nav menu-tabs">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="<?php echo site_url('admin/kaizenidea/dashboard'); ?>">
      <svg id="icon-home1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-box"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
  ...
  <?php /*
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="index.html#dashboard">
      <svg id="icon-home1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-box"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
    </a>
  </li>
  ...
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="index.html#apps">
  ...
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="index.html#components">
  ...
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="index.html#forms">
  ...
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="index.html#table">
  ...
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="index.html#extra">
